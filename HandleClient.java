...
/////////////splitting file///
 ...
 guiinst.writetolog("Spiltting File Completed ");
                    ...
                    case 2: // File Download Request
                    {
                        ...
                        try {
                            ...
                            if (Bswabe.downloadfileflag) {
                                ...
                                joinFile.join(common.getinstance().filepath+ fd.filename);
                                guiinst.writetolog("successfully recreated file");
                                String fulfile =common.getinstance().filepath+fd.filename+".new";
